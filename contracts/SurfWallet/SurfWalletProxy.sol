...
/// @title SurfWalletProxy - Generic proxy contract allows to execute all transactions applying the code of a master contract.
/// @dev can be deployed and initialized using one entrypoint operation
contract SurfWalletProxy is GnosisSafeProxy {
